...
<div class="an_panel_info">
    <div class="an_panel_info-item an_panel_info-item-contact">
        <h2>Contact Us</h2>
        <p><a class="an_panel-link" href="{$contact_us|escape:'htmlall':'UTF-8'}" target="_blank">Contact us</a> on any question or problem with the module</p>
    </div>
	{if $rate_url <> ''}
    <div class="an_panel_info-item an_panel_info-item-rate">
        <h2>Rate{if isset($theme.name) AND $theme.name != ''} "{$theme.name|escape:'htmlall':'UTF-8'}"{/if}</h2>
        <div class="grade">
    ...
    <div class="an_panel_info-item an_panel_info-item-docs">
        <h2><a class="an_panel-link" href="{$anvanto_url|escape:'htmlall':'UTF-8'}" target="_blank">What's next?</a></h2>
        <p>Find out how to improve your shop with <a href="{$anvanto_url|escape:'htmlall':'UTF-8'}" class="suggestions-link"  target="_blank">other modules and themes</a> made by Anvanto.</p>
    </div>
