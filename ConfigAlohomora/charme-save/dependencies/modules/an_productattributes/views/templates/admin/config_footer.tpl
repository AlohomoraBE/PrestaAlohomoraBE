...
<div id="anlazyloading" class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="suggestions-item suggestions-item_green">
            <h2 class="suggestions-title"><a href="https://goo.gl/XTjgWW">Support</a></h2>
            <p class="suggestions-desc"><a href="https://goo.gl/XTjgWW" class="suggestions-link">Contact us</a> on any question or problem with the module.</p>
        </div>
