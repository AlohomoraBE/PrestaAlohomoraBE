    ...
    {block name='cart_summary_products'}
      <div class="cart-summary-products">
        ...
        <p class="checkout-summary-dropdown">
          <a href="#" data-toggle="collapse" data-target="#cart-summary-product-list" class="collapsed show-details-cart">
            ...
            <path fill-rule="evenodd"  fill="rgb(57, 181, 208)"
             d="M4.506,5.004 L0.012,0.007 L9.000,0.007 L4.506,5.004 Z"/>
            </svg>
          </a>
        </p>
