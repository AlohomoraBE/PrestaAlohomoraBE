...
{$contact_us = 'https://bit.ly/3cFUEDv'}
{$rate_url = 'https://bit.ly/2XDs29E'}
...
<div class="an_panel_info">
    ...
    <div class="an_panel_info-item an_panel_info-item-docs">
        <h2>Documentation</h2>
        <p>If you need help or any question / problem watch our <a  class="an_panel-link" href="../modules/anthemeblocks/doc/readme_en.pdf" target="_blank">documentation</a>.</p>
    </div>
	{*
    <div class="an_panel_info-item an_panel_info-item-docs">
        <h2><a class="an_panel-link" href="https://bit.ly/3bz7G5D" target="_blank">What's next?</a></h2>
        <p>Find out how to improve your shop with <a href="https://bit.ly/3bz7G5D" class="suggestions-link">other modules and themes</a> made by Anvanto.</p>
    </div>	
	*}
</div>