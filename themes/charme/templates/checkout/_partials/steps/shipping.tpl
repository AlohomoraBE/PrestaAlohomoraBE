      ...
      >
        <div class="form-fields">
          ...
          <div class="order-options">
            <div id="delivery">
              <label class="delivery-message" for="delivery_message">{l s='If you would like to add a comment about your order, please write it in the field below.' d='Shop.Theme.Checkout'}</label>
